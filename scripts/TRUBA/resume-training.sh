...
python ./utils/inspect_results.py --command print_resumable_experiment_configurations --campaign_name ${experiment_name} --db_type ${experiment_logs_dir} | \

while read experiment_log_line; do

#    read experiment_log_dir model_dir_path model_epoch_dir_path starting_epoch_no <<<$(IFS=" "; echo $experiment_log_line)
#    echo $model_dir_path
#    echo $model_epoch_dir_path
#    echo $starting_epoch_no
