...
bash ${rundir_path}/helper-script-to-run-the-wo_root-experiment-set-over-all-languages-TRUBA.sh ${experiment_name} ${dim} ./scripts/TRUBA/configuration-variables.sh ${debug} "${target_languages}" | while read line; do
