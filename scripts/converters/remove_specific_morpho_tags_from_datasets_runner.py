...
for lang_name in lang_names:
    ...
    related_entity_type_and_top_or_bottom_labels += [(x[0], x[1].split(",")) for x in list(c_parser.items('general')) if (x[0].startswith("zero_group_") or x[0].startswith("near_zero_group_"))]
